...
<?php
    ...
    if(!$sucesso){ 
        ...
        $transacao_id = $retorno['transacao_id']; //ID da transação
        ...
        $nao_autorizado_codigo = isset($retorno['nao_autorizado_codigo']) ? $retorno['nao_autorizado_codigo'] : null; // Código de não autorização de transação com cartão
        $nao_autorizado_mensagem = isset($retorno['nao_autorizado_mensagem']) ? $retorno['nao_autorizado_mensagem'] : null; // Mensagem de não autorização de transação com cartão
